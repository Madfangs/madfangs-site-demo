function SearchResults(props) {
    const element = <React.Fragment>
        {props.data.map(person=>{
            return (<a href={props.domain + "dashboard/" + person.username} className="d-block col-12 friend-card border border-dark p-3 mb-3">
...
function SocialBlock(props) {
    ...
    const element = <React.Fragment>
        <div className="container-fluid">
            ...
            <SearchResults data={props.searchData} domain={props.domain} addFriend={props.addFriend} available={props.available} />
        </div>
    </React.Fragment>;
    return element;
}