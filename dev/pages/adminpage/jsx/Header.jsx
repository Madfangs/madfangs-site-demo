            ...
            if (!brfound) {
                ...
                if (nav.link === props.activeNav) {
                    if(nav.link === 'notifications')
                        return <NotificationTab key={nav} nav={nav} active="active" domain={props.domain} numOfNotifications={props.numOfNotifications} />;
                    else
                        return <NavbarLinks key={nav} nav={nav} active="active" domain={props.domain} />;
                }
                if(nav.link === 'notifications')
                    return <NotificationTab key={nav} nav={nav} active="" domain={props.domain} numOfNotifications={props.numOfNotifications} />;
                else
